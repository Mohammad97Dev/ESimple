...
using ESimple.Authorization.Accounts;
using ESimple.Authorization.Roles;
using ESimple.Authorization.Users;
using ESimple.Roles.Dto;
using ESimple.Users.Dto;
using Microsoft.AspNetCore.Identity;
using Microsoft.EntityFrameworkCore;

namespace ESimple.Users
{
    ...
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
        ...
        [AbpAuthorize(PermissionNames.Pages_Users_RolesList)]
